...
parser.add_argument('--input-transform', default='',
                    choices=['', 'log', 'logmel', 'logmel23', 'logmel23_mn',
                             'logmel23_mvn', 'logmel23_swn', 'logmel23_new'],
...
parser.add_argument('--der-ratio', default=0, type=float)
parser.add_argument('--threshold', default=0.5, type=float)
parser.add_argument('--use-best-model',
                    help='use the best model or not',
                    default=True,
                    type=bool)
parser.add_argument('--pre-emphasis',
                    help='use pre emphasis for pre processing or not',
                    default=True,
                    type=bool)
parser.add_argument('--aug',
                    help='use Augment for training or not',
                    default=True,
                    type=bool)
